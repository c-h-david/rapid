...
sed -i -e "s|IS_riv_tot         =.*|IS_riv_tot         =658702|"               \
       -e "s|rapid_connect_file =.*|rapid_connect_file ='../../rapid/input/WSWM_XYZ/rapid_connect_WSWM.csv'|" \
       -e "s|IS_max_up          =.*|IS_max_up          =12|"                   \
       -e "s|Vlat_file          =.*|Vlat_file          ='../../rapid/input/WSWM_XYZ/m3_riv_WSWM_19970101_19981231_VIC0125_cst_10p.nc'|" \
          rapid_namelist_WSWM_XYZ
...
sed -i -e "s|IS_riv_bas         =.*|IS_riv_bas         =658702|"               \
       -e "s|riv_bas_id_file    =.*|riv_bas_id_file    ='../../rapid/input/WSWM_XYZ/riv_bas_id_WSWM_hydroseq.csv'|" \
          rapid_namelist_WSWM_XYZ
...
#Regular model run
#*******************************************************************************
sed -i -e "s|k_file             =.*|k_file             ='../../rapid/input/WSWM_XYZ/k_WSWM_ag.csv'|" \
       -e "s|x_file             =.*|x_file             ='../../rapid/input/WSWM_XYZ/x_WSWM_ag.csv'|" \
       -e "s|Qout_file          =.*|Qout_file          ='../../rapid/output/WSWM_XYZ/Qout_WSWM_729days_p0_dtR900s_nx_method.nc'|" \
       -e "s|V_file             =.*|V_file             ='../../rapid/output/WSWM_XYZ/V_WSWM_729days_p0_dtR900s_nx_method.nc'|" \
          rapid_namelist_WSWM_XYZ  
...
#Routing parameters
#-------------------------------------------------------------------------------
sed -i -e "s|kfac_file          =.*|kfac_file          ='../../rapid/input/WSWM_XYZ/kfac_WSWM_1km_hour.csv'|" \
...
sed -i -e "s|IS_obs_tot         =.*|IS_obs_tot         =1562|"                   \
       -e "s|obs_tot_id_file    =.*|obs_tot_id_file    ='../../rapid/input/WSWM_XYZ/gage_id_WSWM_1997_1998_full.csv'|" \
       -e "s|Qobs_file          =.*|Qobs_file          ='../../rapid/input/WSWM_XYZ/Qobs_WSWM_1997_1998_full.csv'|" \
       -e "s|Qobsbarrec_file    =.*|Qobsbarrec_file    =''|"                   \
       -e "s|IS_obs_use         =.*|IS_obs_use         =1562|"                   \
       -e "s|obs_use_id_file    =.*|obs_use_id_file    ='../../rapid/input/WSWM_XYZ/gage_id_WSWM_1997_1998_full.csv'|" \
