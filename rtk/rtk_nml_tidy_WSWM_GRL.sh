...
sed -i -e "s|IS_riv_tot         =.*|IS_riv_tot         =658702|"               \
       ...
       -e "s|Vlat_file          =.*|Vlat_file          ='../../rapid/input/WSWM_GRL/m3_riv_WSWM_19970101_19981231_VIC0125_cst_10p.nc'|" \
          rapid_namelist_WSWM_GRL
...
sed -i -e "s|k_file             =.*|k_file             ='../../rapid/input/WSWM_GRL/k_WSWM_ag.csv'|" \
       ...
       -e "s|Qout_file          =.*|Qout_file          ='../../rapid/output/WSWM_GRL/Qout_WSWM_729days_p0_dtR900s_nx_method.nc'|" \
       -e "s|V_file             =.*|V_file             ='../../rapid/output/WSWM_GRL/V_WSWM_729days_p0_dtR900s_nx_method.nc'|" \
          rapid_namelist_WSWM_GRL
