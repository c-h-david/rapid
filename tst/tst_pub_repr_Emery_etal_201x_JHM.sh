...
#-------------------------------------------------------------------------------
rm -f rapid_namelist
ln -s rapid_namelist_San_Guad_DA_JHM rapid_namelist
...
./tst_nml_tidy_San_Guad_DA_JHM.sh
echo "Running simul. $sim/21"
Qout_file='../../rapid/output/San_Guad_DA_JHM/Qout_San_Guad_DA_run00_n1_preonly_tst.nc'
Qout_gold='../../rapid/output/San_Guad_DA_JHM/Qout_San_Guad_DA_run00.nc'
...
sed -i -e "s|Qout_file          =.*|Qout_file          ='$Qout_file'|"         \
       -e "s|IS_opt_run         =.*|IS_opt_run         =1|"                    \
          rapid_namelist_San_Guad_DA_JHM
sleep 3
...
Qout_file="../../rapid/output/San_Guad_DA_JHM/Qout_San_Guad_DA_run${run_st}_n1_preonly_tst.nc"
Qout_gold="../../rapid/output/San_Guad_DA_JHM/Qout_San_Guad_DA_run${run_st}.nc"
rapd_file="tmp_run_$sim.txt"
comp_file="tmp_run_comp_$sim.txt"
sed -i -e "s|Qout_file          =.*|Qout_file          ='$Qout_file'|"         \
...
./tst_nml_tidy_San_Guad_DA_JHM.sh
echo "Running simul. $sim/21"
Qout_file="../../rapid/output/San_Guad_DA_JHM/Qout_San_Guad_DA_run00_UQ_24H_n1_preonly_tst.nc"
Qout_gold="../../rapid/output/San_Guad_DA_JHM/Qout_San_Guad_DA_run00_UQ_24H.nc"
rapd_file="tmp_run_$sim.txt"
comp_file="tmp_run_comp_$sim.txt"
sed -i -e "s|Qout_file          =.*|Qout_file          ='$Qout_file'|"         \
       -e "s|IS_opt_run         =.*|IS_opt_run         =1|"                    \
       -e "s|BS_opt_uq          =.*|BS_opt_uq          =.true.|"               \
       -e "s|Vlat_file          =.*|Vlat_file          ='../../rapid/input/San_Guad_DA_JHM/m3_riv_NLDAS_VIC0125_3H_2010_2013_utc_err24H_R286.nc'|" \
          rapid_namelist_San_Guad_DA_JHM
sleep 3
mpiexec -n 1 ./rapid -ksp_type preonly > $rapd_file
echo "Comparing files"
...
./tst_nml_tidy_San_Guad_DA_JHM.sh
echo "Running simul. $sim/21"
Qout_file="../../rapid/output/San_Guad_DA_JHM/Qout_San_Guad_DA_run00_UQ_24Hscaled_n1_preonly_tst.nc"
Qout_gold="../../rapid/output/San_Guad_DA_JHM/Qout_San_Guad_DA_run00_UQ_24Hscaled.nc"
rapd_file="tmp_run_$sim.txt"
comp_file="tmp_run_comp_$sim.txt"
sed -i -e "s|Qout_file          =.*|Qout_file          ='$Qout_file'|"         \
       -e "s|IS_opt_run         =.*|IS_opt_run         =1|"                    \
       -e "s|BS_opt_uq          =.*|BS_opt_uq          =.true.|"               \
       -e "s|Vlat_file          =.*|Vlat_file          ='../../rapid/input/San_Guad_DA_JHM/m3_riv_NLDAS_VIC0125_3H_2010_2013_utc_scalederr24H_R286.nc'|" \
          rapid_namelist_San_Guad_DA_JHM
sleep 3
mpiexec -n 1 ./rapid -ksp_type preonly > $rapd_file
echo "Comparing files"
...
./tst_nml_tidy_San_Guad_DA_JHM.sh
echo "Running simul. $sim/21"
Qout_file="../../rapid/output/San_Guad_DA_JHM/Qout_San_Guad_DA_run00_UQ_M_n1_preonly_tst.nc"
Qout_gold="../../rapid/output/San_Guad_DA_JHM/Qout_San_Guad_DA_run00_UQ_M.nc"
rapd_file="tmp_run_$sim.txt"
comp_file="tmp_run_comp_$sim.txt"
sed -i -e "s|Qout_file          =.*|Qout_file          ='$Qout_file'|"         \
       -e "s|IS_opt_run         =.*|IS_opt_run         =1|"                    \
       -e "s|BS_opt_uq          =.*|BS_opt_uq          =.true.|"               \
       -e "s|Vlat_file          =.*|Vlat_file          ='../../rapid/input/San_Guad_DA_JHM/m3_riv_NLDAS_VIC0125_3H_2010_2013_utc_errM_R286.nc'|" \
