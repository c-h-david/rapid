...
#values.
#Authors:
#Charlotte M. Emery, Cedric H. David, 2017-2023.
...
sed -i -e "s|IS_riv_tot         =.*|IS_riv_tot         =5175|"                 \
       ...
       -e "s|Vlat_file          =.*|Vlat_file          ='../../rapid/input/San_Guad_JHM2/m3_riv_San_Guad_20100101_20131231_VIC0125_3H_utc_err_R286_D.nc'|" \
          rapid_namelist_San_Guad_JHM2
