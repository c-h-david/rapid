...
use rapid_var, only :                                                          &
                   ...
                   ZS_k,ZS_x,ZS_knorm,ZS_xnorm,ZV_k,ZV_x,ZS_kfac,ZS_xfac,      &
                   ...
                   ZS_one,IS_one,ZV_pointer,temp_char,                         &
...
!*******************************************************************************
!Set initial volumes and flowrates for optimization procedure 
!*******************************************************************************
ZS_phi=0
...
!call PetscPrintf(PETSC_COMM_WORLD,'ZV_k' // char(10),ierr)
!call VecView(ZV_k,PETSC_VIEWER_STDOUT_WORLD,ierr)
!call PetscPrintf(PETSC_COMM_WORLD,'ZV_x' // char(10),ierr)
!call VecView(ZV_x,PETSC_VIEWER_STDOUT_WORLD,ierr)
...
!read(31,'(10e10.3)') ZV_read_reachtot
...
!call PetscPrintf(PETSC_COMM_WORLD,'ZV_Vlat' // char(10),ierr)
!call VecView(ZV_Vlat,PETSC_VIEWER_STDOUT_WORLD,ierr)
...
!This one for NHDPlus application

!read(33,'(10e10.3)') ZV_read_reachtot
!call VecSetValues(ZV_Qobs,IS_reachbas,IV_basin_loc,                            &
!                  ZV_read_reachtot(IV_basin_index),INSERT_VALUES,ierr)
!call VecAssemblyBegin(ZV_Qobs,ierr)
!call VecAssemblyEnd(ZV_Qobs,ierr)           !set Qobs based on reading a file
!!This one for MODCOU application with old input files, now obsolete
