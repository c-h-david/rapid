...
!*******************************************************************************
use rapid_var, only :                                                          &
                   IS_riv_tot,IS_riv_bas,JS_riv_tot,JS_uq,IS_uq,               &
                   IV_riv_index,IV_riv_loc1,                                   &
                   ZS_TauR,                                                    &
                   ZS_rnd_uni1,ZS_rnd_uni2,ZS_rnd_norm,ZS_pi,                  &
                   ZV_dQlat,ZV_dQout,ZV_sQout,ZM_Net,ZM_A,                     &
                   ZV_riv_tot_dQlat,ZV_riv_tot_sQlat,                          &
...
!*******************************************************************************
!TEMPORARY - Hardcoding of standard deviation in lateral inflow
!*******************************************************************************
ZV_riv_tot_sQlat=10800                                                         !######
!Temporarily initializing ZV_riv_tot_sQlat                                     !######
                                                                               !######
ZV_riv_tot_sQlat=ZV_riv_tot_sQlat/ZS_TauR                                      !######
!Converting from volume to flow rate                                           !######
...
!*******************************************************************************
!TEMPORARY - This should Write into netCDF file instead
!*******************************************************************************
!if (rank==0) print *, ZV_pointer(IS_riv_bas)                                  !######
!TEMPORARY                                                                     !######
